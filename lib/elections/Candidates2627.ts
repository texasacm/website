import type { ElectionCandidatesData } from '@/components/resources/election/ElectionCandidates';

const candidates2627: ElectionCandidatesData = {
    sections: [
        {
            title: 'Candidates for President & Vice President',
            candidates: [
                {
                    name: 'Jayden Park & Suhas Voolla',
                    image: '/elections/2026-27/jayden-suhas.jpg',
                    platforms: [
                        'Hey, we’re Jayden and Suhas, and we’re both CS sophomores running to be your next president and vice president! We both joined ACM last year as freshman, and we’ve come to love the org and the people in it so much in that time. From our very first events, we loved how amazing the entire officer team was, and everyone was super helpful to navigate such a huge change in our lives.',
                        'For both of us, ACM also helped us find a community of fellow chuds within such a huge department (fun fact: we actually met through ACM!). We’re also currently in the internal and corporate teams at ACM, so we have a pretty big breadth of experience within ACM. As president and VP, we hope to continue contributing to such a strong community of super cool people, whether you’re CS or you’ve never touched a computer before. As for specific goals, we want to keep making ACM a welcoming event for more people whether that’s through events, opportunities to meet new people, or  an increased breadth of resources!',
                    ],
                },
            ],
        },
        {
            title: 'Candidates for Treasurer',
            candidates: [
                {
                    name: 'Diego Contreras Suarez',
                    image: '/officer-headshots-2025-26/diego.jpeg',
                    platforms: [
        ...
        },
        {
            ...
            candidates: [
                ...
                },
                {
                    ...
                    image: '/elections/2026-27/election-josh.jpg',
                    platforms: [
