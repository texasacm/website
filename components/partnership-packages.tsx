      ...
      <div className="container px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mb-12 max-w-3xl">
          ...
          <p className="mb-6 text-lg text-gray-700">
            Texas ACM is the largest computer science student organization at UT
            Austin, with over 500 active members. Our members are passionate,
            talented students who are eager to make an impact.
          </p>
          <p className="mb-6 text-lg text-gray-700">
            Texas ACM&apos;s events and initiatives are fully funded by our
            amazing corporate partners.
          </p>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-12 text-center">
            ...
            <p className="mx-auto mb-6 max-w-2xl text-gray-700">
              We&apos;d love to discuss how we can create a partnership that
              meets your recruiting and branding goals while supporting our
              mission to prepare students for successful careers in tech.
            </p>
            <Button size="lg" asChild>
              <a href="mailto:corporate@texasacm.org">
