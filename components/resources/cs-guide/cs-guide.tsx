...
const guideSections = [
    ...
    },
    {
      ...
      description: "Resources for excelling in your courses, including degree planning, tutoring, and effective study habits.",
      links: [
    ...
    },
    {
      ...
      description: "Prepare for your career with resume help, interview practice, and internship search strategies.",
      links: [
    ...
    },
    {
      ...
      theme: "CS Community",
      description: "Connect with peers and get involved in the vibrant CS community at UT Austin.",
      links: [
    ...
    },
    {
      ...
      theme: "Research",
      description: "Dive deeper into specialized fields of computer science and learn about research opportunities.",
      links: [
    ...
    },
    {
      ...
      theme: "Projects",
      description: "Get inspired by projects from other students and find resources to build your own.",
      links: [
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {guideSections.map((section) => (
              <Card key={section.theme} className="flex flex-col shadow-md">
                <CardHeader>
                  <CardTitle className="flex flex-row items-center gap-3"> {section.icon} {section.theme}</CardTitle>
                </CardHeader>
