                        ...
                        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="ml-3">
                                <p className="text-green-700">
                                    Voting for the Texas ACM executive election opens on April 3 at
                                    8:00 AM CST and closes at 6:00 PM CST on the same day. To be
                                    eligible to vote, you must have attended at least three ACM
